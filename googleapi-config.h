/* googleapi-config.h.  Generated from googleapi-config.h.in by configure.  */
/* googleapi-config.h.in.  Generated from configure.ac by autoheader.  */
...
/* Name of package */
#define PACKAGE "googleapi-opt"

/* Define to the address where bug reports for this package should be sent. */
#define PACKAGE_BUGREPORT ""

/* Define to the full name of this package. */
#define PACKAGE_NAME "googleapi-opt"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "googleapi-opt 3.8.8"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "googleapi-opt"
