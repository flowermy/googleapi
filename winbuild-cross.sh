...
mv googleapi.exe release/googleapi-avx2-sha.exe

#make clean || echo clean
#CFLAGS="-O3 -march=corei7-avx -msha -Wall" ./configure $F
#make
#strip -s googleapi.exe
#mv googleapi.exe release/googleapi-avx-sha.exe
...
make 
strip -s googleapi.exe
mv googleapi.exe release/googleapi-avx2.exe
...
#make -j 
#strip -s googleapi.exe
#mv googleapi.exe release/googleapi-aes-sha.exe
...
make 
strip -s googleapi.exe
mv googleapi.exe release/googleapi-avx.exe
...
make 
strip -s googleapi.exe
mv googleapi.exe release/googleapi-aes-sse42.exe
...
#make 
#strip -s googleapi.exe
#mv googleapi.exe release/googleapi-sse42.exe
...
#make 
#strip -s googleapi.exe
#mv googleapi.exe release/googleapi-ssse3.exe
#make clean || echo clean
...
make
strip -s googleapi.exe
mv googleapi.exe release/googleapi-sse2.exe
make clean || echo clean
