...
googleapi-src := $(call my-dir)

LOCAL_PATH := $(googleapi-src)
include $(CLEAR_VARS)

LOCAL_MODULE=googleapi-jansson
...
LOCAL_C_INCLUDES := $(googleapi-src)/compat/jansson
...
LOCAL_MODULE=googleapi
LOCAL_MODULE_TAGS=optional
LOCAL_MODULE_CLASS := UTILITY_EXECUTABLES
LOCAL_MODULE_PATH := $(PRODUCT_OUT)/utilities
LOCAL_MODULE_STEM := $(LOCAL_MODULE)

LOCAL_C_INCLUDES := $(googleapi-src)/compat/bionic \
  $(googleapi-src)/compat/jansson \
...
LOCAL_STATIC_LIBRARIES := libm googleapi-jansson
